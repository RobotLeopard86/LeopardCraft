...
public class ShatteredLeopardSavannaBiome extends Biome {

	public ShatteredLeopardSavannaBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.SAVANNA).depth(0.125F).scale(0.05F).temperature(1.2F).downfall(1.324F).waterColor(4159204).waterFogColor(329011).parent((String)null));
	    ...
	    this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(LeopardEntity.getEntityType(), 6, 2, 6));
