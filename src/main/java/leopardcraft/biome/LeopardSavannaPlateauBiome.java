...
public class LeopardSavannaPlateauBiome extends Biome {
	...
	public LeopardSavannaPlateauBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.SAVANNA).depth(1.5F).scale(0.05F).temperature(1.2F).downfall(1.324F).waterColor(4159204).waterFogColor(329011).parent((String)null));
	    ...
	    this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(LeopardEntity.getEntityType(), 10, 3, 9));
