...
public class LeopardSavannaBiome extends Biome {

	public LeopardSavannaBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.SAVANNA).depth(0.125F).scale(0.05F).temperature(1.2F).downfall(1.324F).waterColor(4159204).waterFogColor(329011).parent((String)null));
		this.func_226711_a_(Feature.VILLAGE.func_225566_b_(new VillageConfig("village/savanna/town_centers", 6)));
	    ...
	    this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(LeopardEntity.getEntityType(), 8, 4, 4));
