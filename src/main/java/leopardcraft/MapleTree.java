...
public class MapleTree extends Tree {
	...
	public static final TreeFeatureConfig MAPLE_TREE_CONFIG_OTHER = new TreeFeatureConfig.Builder(
			new SimpleBlockStateProvider(LeopardCraft.mapleLogBlock.getDefaultState()),
			new SimpleBlockStateProvider(LeopardCraft.mapleLeavesBlock.getDefaultState()),
			new BlobFoliagePlacer(2, 1)).func_225569_d_(6).func_227354_b_(1).func_227360_i_(2).func_227352_a_().setSapling((IPlantable) LeopardCraft.mapleSaplingBlock).func_225568_b_();


	@Override
	protected ConfiguredFeature<TreeFeatureConfig, ?> func_225546_b_(Random p_225546_1_, boolean p_225546_2_) {
		return p_225546_1_.nextInt(10) == 0 ? Feature.FANCY_TREE.func_225566_b_(MAPLE_TREE_CONFIG/*p_225546_2_ ? DefaultBiomeFeatures.field_226817_l_ : DefaultBiomeFeatures.field_226815_j_*/) : Feature.NORMAL_TREE.func_225566_b_(MAPLE_TREE_CONFIG_OTHER/*p_225546_2_ ? DefaultBiomeFeatures.field_226816_k_ : DefaultBiomeFeatures.field_226739_a_*/);
	}}